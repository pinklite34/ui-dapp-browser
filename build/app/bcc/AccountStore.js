...
var AccountStore = /** @class */ (function () {
     ...
     */
    AccountStore.prototype.getPrivateKey = function (activeAccount) {
        if (activeAccount === void 0) { activeAccount = core.activeAccount(); }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, lightwallet.loadUnlockedVault()];
                    case 1:
                        _a = (_b.sent());
                        _b.label = 2;
                    case 2:
                        ...
                        return [2 /*return*/, this.accounts[activeAccount]];
                }
            });
        });
    };
