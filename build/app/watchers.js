 ...
 */
export var startWatchers = function () {
    setInterval(function () { return watchForEveLow(); }, 10 * 1000);
};
/**
 ...
 */
export var watchForEveLow = function () { return __awaiter(_this, void 0, void 0, function () {
    var activeAccount, balance, disableWarnings;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                activeAccount = core.activeAccount();
                if (!activeAccount) return [3 /*break*/, 2];
                return [4 /*yield*/, core.getBalance(activeAccount)];
            case 1:
                balance = _a.sent();
                ...
                if (balance <= 0.1) {
                    ...
                    disableWarnings = window.localStorage['evan-warnings-disabled'] || '{ }';
                    try {
